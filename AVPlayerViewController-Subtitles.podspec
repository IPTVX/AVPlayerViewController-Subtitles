Pod::Spec.new do |spec|
  ...
  spec.homepage         = 'https://github.com/IPTVX/AVPlayerViewController-Subtitles'
  spec.authors          = { 'Marc Hervera' => 'mhergon@gmail.com' }
  spec.summary          = 'Subtitles made easy'
  spec.source           = { :git => 'https://github.com/IPTVX/AVPlayerViewController-Subtitles.git', :tag => 'v1.3.1' }
